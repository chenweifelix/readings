...
[Go to Overview](./Overview.nb.html)

[Go to Reading log](./Reading-log.nb.html)

[Go to Thoughts log](./Thoughts-log.nb.html)
...
- Social media platforms as facilitators of public discourse (Guess et al., 2023)
- Biological adaptations tend to have both costs and benefits (Connolly et al., 2019)
- Democracy is at risk when citizens become so polarized that an ‘us versus them’ mentality dominates (Jost et al., 2022)
- Anyone can be angry—that is easy. But to be angry with the right person, to the right degree, at the right time, for the right purpose, and in the right way—that is not easy (Leach & Bou Zeineddine, 2021)
- Emotions are not just the fuel that powers the psychological mechanism of a reasoning creature, they
are parts, highly complex and messy parts, of this creature’s reasoning itself (Bou Zeineddine & Leach, 2021)
## Some numbers 
<hr> 
- Social disconnection and loneliness increase the odds of all-cause mortality by more than 25% and have been labeled an epidemic by the United States Surgeon General (Holt-Lunstad et al., 2015; Murthy, 2023).

# Notes

- For the importance of affective science, see: 
  - The rise of affectivism 
  - Simmons et al 2023, Affective science
    - Multiple agencies of NIH provided funding relevent for affective scientists 
...
## Fung, H. H. (2024). Aging in culture revisited. Current Opinion in Psychology, 56, 101777. https://doi.org/10.1016/j.copsyc.2023.101777
  - The aging in culture model: with age, people internalize the values around them to become better members of their society 
...
## Mooijman, M., Hoover, J., Lin, Y., Ji, H., & Dehghani, M. (2018). Moralization in social networks and the emergence of violence during protests. Nature Human Behaviour, 2(6), Article 6. https://doi.org/10.1038/s41562-018-0353-0 `r colored(" [[Note](./Mooijman_etal_2018/Mooijman_etal_2018.nb.html)]","#8CC1DE" ,"14pt")`
...
## Simchon, A., Brady, W. J., & Van Bavel, J. J. (2022). Troll and divide: The language of online polarization. PNAS Nexus, 1(1), pgac019. https://doi.org/10.1093/pnasnexus/pgac019 `r colored(" [[Note](./Simchon_etal_2022/Simchon_etal_2022.nb.html)]","#8CC1DE" ,"14pt")`
...
Brady, W. J., McLoughlin, K. L., Torres, M. P., Luo, K. F., Gendron, M., & Crockett, M. J. (2023). `r colored(" [[Note](./Brady_etal_2023/Brady_etal_2023.nb.html)]","#8CC1DE" ,"14pt")`
Overperception of moral outrage in online social networks inflates beliefs about intergroup hostility. Nature Human Behaviour, 7(6), Article 6. https://doi.org/10.1038/s41562-023-01582-0

Brady, W. J., Wills, J. A., Jost, J. T., Tucker, J. A., & Van Bavel, J. J. (2017). `r colored(" [[Note](./Brady_etal_2017/Brady_etal_2017.nb.html)]","#8CC1DE" ,"14pt")`
Emotion shapes the diffusion of moralized content in social networks. Proceedings of the National Academy of Sciences, 114(28), 7313–7318. https://doi.org/10.1073/pnas.1618923114
...
## Fan, L., Molho, C., Kupfer, T. R., Sauter, D. A., & Tybur, J. M. (2024). `r colored(" [[Note](./Fan_etal_2024/Fan_etal_2024.nb.html)]","#8CC1DE" ,"14pt")` 
Beyond outrage: Observers anticipate different behaviors from expressors of anger versus disgust. Social Psychological and Personality Science, 15(4), 450–460. https://doi.org/10.1177/19485506231176954
...
Connolly, P.-S., Hull, T. D., & Bonanno, G. A. (2019). `r colored(" [[Note](./Connolly_etal_2019/Connolly_etal_2019.nb.html)]","#8CC1DE" ,"14pt")`
A regulatory flexibility perspective on positive emotion. In J. Gruber (Ed.), The Oxford Handbook of Positive Emotion and Psychopathology (pp. 50–63). Oxford University Press. https://books.google.com/books?hl=en&lr=&id=lvarDwAAQBAJ&oi=fnd&pg=PA50&dq=info:eXPLeeqtWk0J:scholar.google.com&ots=Xn6lW7p6sx&sig=ruD5w_zGcgMV2YGHHwuq1KBkwLo
...
### Yu, J., & Chaudhry, S. J. (2023).  `r colored(" [[Note](./Yu_Chaudhry_2023/Yu_Chaudhry_2023.nb.html)]","#8CC1DE" ,"14pt")`
“Thanks, but no thanks”: Gratitude expression paradoxically signals distance. Journal of Personality and Social Psychology. https://doi.org/10.1037/pspi0000435

This is very similar to Zhang, N., Ji, L.-J., Bai, B., & Li, Y. (2018). Culturally divergent consequences of receiving thanks in close relationships. Emotion, 18(1), 46–57. https://doi.org/10.1037/emo0000385

### Clark, M. S., & Lemay, E. P. (2024). `r colored("[[Note](./Clark_Lemay_2024/Clark_Lemay_2024.nb.html)]","#8CC1DE" ,"14pt")`
When emotion expression will (and will not) enhance listening and responsiveness. Current Opinion in Psychology, 55, 101695. https://doi.org/10.1016/j.copsyc.2023.101695
...
## Wang, S.-Y. N., & Inbar, Y. (2021). `r colored(" [[Note](./Wang_Inbar_2021/Wang_Inbar_2021.nb.html)]","#8CC1DE" ,"14pt")` 
Moral-language use by U.S. political elites. Psychological Science, 32(1), 14–26. https://doi.org/10.1177/0956797620960397
...
## Miller, G. A. (1969). `r colored("[[Note](./Miller_1969/Miller_1969.nb.html]","#8CC1DE" ,"14pt")`
Psychology as a means of promoting human welfare. American Psychologist, 24(12), 1063–1075. https://doi.org/10.1037/h0028988

## Caplan, N., & Nelson, S. D. (1973).`r colored("[[Note](./Caplan_Nelson_1973/Caplan_Nelson_1973.nb.html]","#8CC1DE" ,"14pt")`
On being useful: The nature and consequences of psychological research on social problems. American Psychologist, 28(3), 199–211. https://doi.org/10.1037/h0034433
...
## Firth, J., Torous, J., López-Gil, J. F., Linardon, J., Milton, A., Lambert, J., Smith, L., Jarić, I., Fabian, H., Vancampfort, D., Onyeaka, H., Schuch, F. B., & Firth, J. A. (2024). `r colored(" [[Note](./Firth_etal_2024/Firth_etal_2024.nb.html)]","#8CC1DE" ,"14pt")`
From “online brains” to “online lives”: Understanding the individualized impacts of Internet use across psychological, cognitive and social dimensions. World Psychiatry, 23(2), 176–190. https://doi.org/10.1002/wps.21188
...
## Carlson, R. W., Bigman, Y. E., Gray, K., Ferguson, M. J., & Crockett, M. J. (2022). `r colored("[[Note](./Carlson_etal_2022/Carlson_etal_2022.nb.html)]","#8CC1DE" ,"14pt")`
How inferred motives shape moral judgements. Nature Reviews Psychology, 1(8), 468–478. https://doi.org/10.1038/s44159-022-00071-x

## Mooijman, M., Hoover, J., Lin, Y., Ji, H., & Dehghani, M. (2018). `r colored("[[Note](./Mooijman_etal_2018/Mooijman_etal_2018.nb.html)]","#8CC1DE" ,"14pt")`
Moralization in social networks and the emergence of violence during protests. Nature Human Behaviour, 2(6), Article 6. https://doi.org/10.1038/s41562-018-0353-0

## D’Amore, C., van Zomeren, M., & Koudenburg, N. (2022). `r colored("[[Note](./DAmore_elal_2022/DAmore_elal_2022.nb.html)]","#8CC1DE" ,"14pt")`
Attitude moralization within polarized contexts: An emotional value-protective response to dyadic harm cues. Personality and Social Psychology Bulletin, 48(11), 1566–1579. https://doi.org/10.1177/01461672211047375
...
- Have this quote of Hume that basically says passion overrides cognition 
...
## Jost, J. T., Baldassarri, D. S., & Druckman, J. N. (2022). `r colored("[[Note](./Jost_elal_2022/Jost_elal_2022.nb.html)]","#8CC1DE" ,"14pt")`
Cognitive–motivational mechanisms of political polarization in social-communicative contexts. Nature Reviews Psychology, 1(10), 560–576. https://doi.org/10.1038/s44159-022-00093-5
...
## Simmons, J. M., Breeden, A., Ferrer, R. A., Gillman, A. S., Moore, H., Green, P., Pariyadath, V., Quinlan, E. B., & Vicentic, A. (2023).  
Affective science research: Perspectives and priorities from the national institutes of health. Affective Science, 4(3), 600–607. https://doi.org/10.1007/s42761-023-00218-w
